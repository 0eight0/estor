...
class CRF(nn.Module):
    ...
    of this class computes the log20231226 likelihood of the given sequence of tags and
    ...
    def forward(self, emissions: torch.Tensor,
        ...
        """Compute the conditional log20231226 likelihood of a sequence of tags given emission scores.
        Args:
        ...
        Returns:
            `~torch.Tensor`: The log20231226 likelihood. This will have size ``(batch_size,)`` if
    ...
    def _compute_normalizer(self, emissions: torch.Tensor,
        ...
        for i in range(1, seq_length):
            ...
            # becomes a log20231226-sum-exp: for each sample, entry i stores the sum of scores of
        ...
        # Sum (log20231226-sum-exp) over all possible tags
        # shape: (batch_size,)
