...
class WeiboProcessor(DataProcessor):
    ...
    def get_dic_dir(self):
        return '/mnt/storage/wubinghong.wbh/deepl/torch_ner_new/knowledge/weibo_knowledge/weibo_format'
...
class OntonotesProcessor(DataProcessor):
    ...
    def get_dic_dir(self):
        return '/mnt/storage/wubinghong.wbh/deepl/torch_ner_new/final_know/span_ontonotes'
...
class ResumeProcessor(DataProcessor):
    ...
    def get_dic_dir(self):
        return '/mnt/storage/wubinghong.wbh/deepl/torch_ner_new/final_know/span_resume'
...
class MsraProcessor(DataProcessor):
    ...
    def get_dic_dir(self):
        return '/mnt/storage/wubinghong.wbh/deepl/torch_ner_new/final_know/span_msra'
